...
export class CheckoutNotFoundException extends AppException<{ checkoutId: string }> {
  constructor(checkoutId: string) {
    super(HttpStatus.NOT_FOUND, 'checkout_not_found', 'Checkout not found', { checkoutId });
  }
}
