...
import { UkrposhtaConfig, ukrposhtaConfig } from './ukrposhta.config';
...
@Injectable()
export class UkrposhtaApi extends ExternalApi {
  private readonly settings: UkrposhtaConfig = ukrposhtaConfig;
