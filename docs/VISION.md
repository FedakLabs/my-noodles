...
> **We don't sell imported food. We sell discovery — a small, joyful adventure for the day.**
>
> _Не «просто імпорт» — ми продаємо відкриття через їжу._

This document is our north star. Before any feature, screen, or line of code, ask one question:

**Does this make the customer feel more welcome, more delighted, and more confident — and convinced — to try something new today?**

If the answer isn't a clear yes, we reconsider. Everything we build is about the customer — the rest is just plumbing.

We're not just serving demand that already exists; through a **tasty UI and irresistible, honest descriptions we create the craving** and gently encourage people to try. The target feeling is:

> _"Everything looks so tasty — what should I try?!"_

That captures the shift we engineer: a visitor who arrived in no particular mood (or wanting something but with no idea what) leaves with their appetite switched on and a specific discovery in hand.

---

## The experience we promise

When someone opens our store, we want them to feel:
...
## Why we exist (the human truth)

People want novelty and a little emotion in their day, but trying new imported food is harder and scarier than it should be:
...
We design for people chasing a small, affordable joy (≈300–1200 UAH) and the feeling of an adventure:

- **The novelty-seekers** — students and young professionals who love a quick hit of "dopamine novelty."
- **The fans** — anime / games / K-pop and Asian pop-culture lovers who want "the thing from the video."
- **The gastro-curious** — people who simply love discovering new tastes.
...
## Experience principles (how every screen should feel)

These translate the feeling into rules for building:
...
7. **Safe and reassuring.** Clear ordering, transparent delivery expectations, and a friendly human (Telegram) on the other side.
...
- **Love after the box**: post-delivery satisfaction (NPS), low returns.
- **Healthy acquisition** once paid channels start (CAC/ROAS, share of organic).

In the MVP, the immediate goal is **behavioral data**: understanding what makes people light up, so we keep amplifying it.

---

## How we reach people

Our growth is social-first and discovery-driven — the channels mirror the product:

- **TikTok / Instagram Reels** — taste-story reviews, reactions, "country of the month," unboxings.
- **SEO** — "asian snacks," "japanese sweets," "mochi," "tiktok foods," "gift box."
- **Drops / limited editions** — fresh arrivals every 1–2 weeks (FOMO) + pre-orders.
- **Referrals** — "bring a friend, both get a bonus snack/discount."
- **Partnerships & community** — coworkings/offices, events, anime/gaming communities.
...
- A cold, generic "online shop" that just lists products.
- Information overload, dark patterns, or pushy upsells.
- Dishonest or exaggerated descriptions that betray trust.
- Complexity that makes trying something new feel like work.

---

## In one breath (unique proposition)

**Make people feel welcome, spark the joy of discovering something new, earn their trust with honesty, and make buying it feel effortless and delightful — every single day.** That is the experience we are building. Everything else serves it.
